        ...
        $.post('../controlador/ConsolaController.php', { funcion }, (response) => {
            ...
            consola.forEach(consola => {
                ...
                <tr>
                    ...
                    <a href="../vista/editarConsola.php?id_consola=${consola.id_consola}"><button type="button" class="edit_consola btn btn-warning" data-toggle="modal" data-target="#modalConsola" style="font-size:50%"><i class="fas fa-edit"></i></button></a>
